<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="NhanTienMatBS.aspx.cs" Inherits="TinhLuong.Reports.BaoCaoChung.NhanTienMatBS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvReport" style="width: 100%">
        <CR:CrystalReportViewer ID="Rpt_FrmBS_NhanTienMat" runat="server" HasCrystalLogo="False"
