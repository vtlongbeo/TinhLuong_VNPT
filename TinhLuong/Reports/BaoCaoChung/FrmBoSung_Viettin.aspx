<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="FrmBoSung_Viettin.aspx.cs" Inherits="TinhLuong.Reports.BaoCaoChung.FrmBoSung_Viettin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <style>
    ...
    <div id="dvReport" style="width: 100%">
        <CR:CrystalReportViewer ID="Rpt_FrmBS_ViettinBank" runat="server" HasCrystalLogo="False"
