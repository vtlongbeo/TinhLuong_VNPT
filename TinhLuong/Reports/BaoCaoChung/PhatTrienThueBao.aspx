<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="PhatTrienThueBao.aspx.cs" Inherits="TinhLuong.Reports.BaoCaoChung.PhatTrienThueBao" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.3500.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" style="height:100%">
   <style>
    ...
    <div class="fixedExport" style="position: fixed; right: 0; top: 7%; width: 8em; margin-top: -2.5em;">
      ...
      <div id="dvReport" style="width:100%; height:100%">
            <CR:CrystalReportViewer ID="RptTongHop" runat="server" HasCrystalLogo="False"
               ...
               ToolPanelView="None" BestFitPage="False" SeparatePages="False" ViewStateMode="Enabled" HasDrillUpButton="False" HasPrintButton="False" HasToggleGroupTreeButton="False" ReuseParameterValuesOnRefresh="True" TabIndex="1" />
        </div>
        <br />
