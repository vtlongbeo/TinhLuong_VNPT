...
{
    public partial class KKLaoDong : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            ...
            _rpt = new RptDSChiTietKKLD_CSHT();
            ...
            //dete
            var table = new BaoCaoChungBLL().GetSourceRptDSChiTietKKLD_CSHT(Session["DonVi_BaoCao"].ToString(), int.Parse(Session[SessionCommon.nam].ToString()), int.Parse(Session[SessionCommon.Thang].ToString()));
            ...
            RptTongHop.DataBind();
            var fileName = "/Assets/FileReports/" + Session[SessionCommon.Username].ToString().ToLower() + "/KKLaoDong-" + DateTime.Now.Year + "" + DateTime.Now.Month + "" + DateTime.Now.Day + "" +""+ DateTime.Now.Hour+""+""+ DateTime.Now.Minute+""+ DateTime.Now.Second+""+ DateTime.Now.Millisecond + ".pdf";
            Session.Add("KKLaoDong", fileName);
            _rpt.ExportToDisk(ExportFormatType.PortableDocFormat, Server.MapPath(fileName));
        }

        protected void Button1_Click(object sender, EventArgs e)
        {
            Response.Redirect(Session["KKLaoDong"].ToString());
        }
    }
}