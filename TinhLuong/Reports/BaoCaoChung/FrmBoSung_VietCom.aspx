<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="FrmBoSung_VietCom.aspx.cs" Inherits="TinhLuong.Reports.BaoCaoChung.FrmBoSung_VietCom" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="fixedExport" style="position: fixed; right: 0; top: 7%; width: 8em; margin-top: -2.5em;">
     ...
     <CR:CrystalReportViewer ID="Rpt_FrmBS_VietComBank"  runat="server" HasCrystalLogo="False"
