<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="TBLuongCacDV.aspx.cs" Inherits="TinhLuong.Reports.TBLuongDV.TBLuongCacDV" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvReport" style="width: 100%">
        <CR:CrystalReportViewer ID="RptLuongCacDV" runat="server" HasCrystalLogo="False"
