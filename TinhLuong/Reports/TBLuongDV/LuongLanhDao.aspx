<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="LuongLanhDao.aspx.cs" Inherits="TinhLuong.Reports.LuongLanhDao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvReport" style="width: 100%">
        <CR:CrystalReportViewer ID="RptLuongLanhDao" runat="server" HasCrystalLogo="False"
