<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="ReportKKTT.aspx.cs" Inherits="TinhLuong.Reports.ReportsLuongKKKT.ReportKKTT" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" Text="Print" OnClick="Button1_Click" Style="display: none" /><br />
    <div id="dvReport" style="width: 100%">
        <CR:CrystalReportViewer ID="RptDSLuongKhenThuong" runat="server" HasCrystalLogo="False"
