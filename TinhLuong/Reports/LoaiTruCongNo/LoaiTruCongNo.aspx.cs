...
{
    public partial class LoaiTruCongNo : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            ...
            //dete
            var table = new LoaiTruCongNoBLL().GetLoaiTruCongNo(Session[SessionCommon.DonViID].ToString(), int.Parse(Session[SessionCommon.nam].ToString()), int.Parse(Session[SessionCommon.Thang].ToString()));
