<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="LoaiTruCongNo.aspx.cs" Inherits="TinhLuong.Reports.LoaiTruCongNo.LoaiTruCongNo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvReport" style="width: 100%">
        <CR:CrystalReportViewer ID="RptLoaiTruCongNo" runat="server" HasCrystalLogo="False"
