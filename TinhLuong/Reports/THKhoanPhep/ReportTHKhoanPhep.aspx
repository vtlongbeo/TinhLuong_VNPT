<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="ReportTHKhoanPhep.aspx.cs" Inherits="TinhLuong.Reports.THKhoanPhep.ReportTHKhoanPhep" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <style>
    ...
    <div id="dvReport" style="width: 100%">
        <CR:CrystalReportViewer ID="RptTHKhoanPhep" runat="server" HasCrystalLogo="False"
