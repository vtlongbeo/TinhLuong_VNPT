...
{
    public partial class TongHopKQL : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            ...
            RptTongHopKQL.ReportSource = null;
            //dete
            ...
            RptTongHopKQL.ReportSource = _rpt;
            RptTongHopKQL.DataBind();
            var fileName = "/Assets/FileReports/" + Session[SessionCommon.Username].ToString().ToLower() + "/LuongTongHop_KQL-" + DateTime.Now.Year + "" + DateTime.Now.Month + "" + DateTime.Now.Day + "" + "" + DateTime.Now.Hour + "" + "" + DateTime.Now.Minute + "" + DateTime.Now.Second + "" + DateTime.Now.Millisecond + ".pdf";
            Session.Add("LuongTongHop_KQL", fileName);
            _rpt.ExportToDisk(ExportFormatType.PortableDocFormat, Server.MapPath(fileName));
        }

        protected void Button1_Click(object sender, EventArgs e)
        {
            Response.Redirect(Session["LuongTongHop_KQL"].ToString());
        }
    }
}