<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="TongHopKQL.aspx.cs" Inherits="TinhLuong.Reports.TongHop.TongHopKQL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvReport" style="width: 100%">
        <CR:CrystalReportViewer ID="RptTongHopKQL" runat="server" HasCrystalLogo="False"
