...
{
    public class TinhLuongKeHoachController : BaseController
    {
        // GET: TinhLuongKeHoach
        ...
        public ActionResult TinhLuong(int drpNam, int drpThang, string LoaiLuong, string SoTien)
        {
            string LoaiDV = "";
            decimal LuongVTTN =decimal.Parse( SoTien.Replace(",", ""));
            ...
            {
                rs = new TinhLuongBoSungQuyBLL().TinhLuongKH_Fiber(drpThang, drpNam, LoaiLuong, LuongVTTN, LoaiDV);
