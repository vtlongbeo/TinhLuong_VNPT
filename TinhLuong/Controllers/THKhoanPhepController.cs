...
namespace TinhLuong.Controllers
{
    ...
    public class THKhoanPhepController : BaseController
    {
        // GET: THKhoanPhep
        SaveLog sv = new SaveLog();
        [CheckCredential(RoleID = "VIEW_LUONGKHOANPHEP")]
        public ActionResult Index()
        {
            //sv.save(Session[SessionCommon.Username].ToString(), "Bao cao->Luong Khoan Phep");
        ...
        [CheckCredential(RoleID = "VIEW_LUONGKHOANPHEP")]
        public ActionResult LuongKhoanPhepReport(int thang, int nam, string type)
        {
            Session.Add(SessionCommon.Thang, thang);
            Session.Add(SessionCommon.nam, nam);
            if (type == "print")
            {
             //   sv.save(Session[SessionCommon.Username].ToString(), "Bao cao->Luong Khoan phep->viewReport-thang-" + thang + "-nam-" + nam);
                string content = "~/Reports/THKhoanPhep/ReportTHKhoanPhep.aspx";
                return Redirect(content);
            }
            return Redirect("/THKhoanPhep");
