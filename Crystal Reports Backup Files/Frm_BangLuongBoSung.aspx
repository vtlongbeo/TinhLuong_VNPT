<%@ Page Language="C#" MasterPageFile="~/Views/Shared/ReportSite.Master" AutoEventWireup="true" CodeBehind="Frm_BangLuongBoSung.aspx.cs" Inherits="TinhLuong.Reports.BaoCaoChung.Frm_BangLuongBoSung" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="fixedExport" style="position: fixed; right: 0; top: 7%; width: 8em; margin-top: -2.5em;">
     ...
     <CR:CrystalReportViewer ID="RptBangLuongBoSung"  runat="server" HasCrystalLogo="False"
